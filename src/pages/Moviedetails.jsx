  ...
  return show  ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        <img src={show.movie.poster_path} alt="vvvv" className='max-md:mx-auto
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <p className='text-gray-400 mt-2 text-sm leading leading-tight max-w-xl'>
            ...
            <p>{timeFormat(show.movie.runtime)}• {show.movie.genres.map(genre =>
              ...
              <div className='flex items-center flex-wrap gap-4 mt-4'>
                ...
                bg-gray-800 hover:bg-gray-900 trtansition rounded-md font-medium
              ...
              <p className='text-lg font-medium mt-20'>Your Favourite casts</p>
